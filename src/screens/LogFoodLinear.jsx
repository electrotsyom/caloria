 ...
 * scoped `.theme-caloria` stylesheet: neutral near-black surfaces and hairline
 * borders. Mirrors RecipesLinear / RecipeDetailsLinear.
 *
 * Under the `theme-caloria-logfood` marker, the inline "+" add buttons adopt the
...
export default function LogFoodLinear() {
  return (
    <div className="theme-caloria theme-caloria-logfood">
